...
local _W = magicres.width--display.contentWidth
local _H = magicres.height--display.contentHeight
...
function director:changeScene( params,
	...
	elseif effect == "fade" then
		...
		nextView.y = 0
		--
		local fade = display.newRect( _W/2, _H/2, _W * 3, _H * 3 )
		fade.alpha = 0
	...
	------------------
		...
		if params and params.nodelay then
			fxEnded()
		else
...
function director:doShoutout(funcname, args)
	if currScreen and currScreen[funcname] then
		currScreen[funcname](currScreen, args)
	end
end